 ...
 * 단, 일 필드가 말일인 경우, 월을 변경하는 케이스엔 일 필드가 변경된다.
 * 
...
public class ShowCalendar {
   ...
   public static void main(String[] args) {
      ...
      if(input != null) {
         ...
         //출력시 해당월의 1일이 어느 요일인지를 파악 후, 이전 요일은 공백을 줍니다.
         for(int i = 1; i<start_Day_Of_week;i++) {
            System.out.print("   ");//3칸 띄세요.
         }
         
         //날짜를 출력 시키는데, 2가지를 생각해야 합니다.
         //1.정렬 : 10일 이전은 문자가 하나이고, 이후는 2개입니다. 따라서 공백을 적절히 이용해서 정렬을 해줄 예정입니다.(1칸,2칸)
