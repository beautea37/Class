...
private static MemberDAO instance = new MemberDAO();
   ...
   public void changePass() {
      ...
      String newPass;
      try {
      FileReader fr = new FileReader("C:\\members\\" + MemberDAO.instance.id + ".properties");
      
      do {
         userPass = JOptionPane.showInputDialog("기존 비밀번호를 입력하세요");
      
      } while (!userPass.equals(MemberDAO.instance.pw));      
         
           File newCFile = new File("C:\\members\\" + MemberDAO.instance.id + ".properties");
           
           MemberDAO.instance.newFile.delete();
         ...
         bw.write("ID : " + MemberDAO.instance.id + "\n");
