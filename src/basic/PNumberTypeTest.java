...
public class PNumberTypeTest {
	...
	public static void main(String[] args) {
		 ...
		 * 세부 자료형을 기술하세요.
		 *p-Type과 r-Type으로 나눌 수 있으며
		  p-type byte, short, char, int, long
		 ...
		 */
			...
			short sh = (short)32790;
			System.out.println(sh);
					
		/* 3.int 타입의 값 범위를 적어보세요.
		 * 
		 */
		System.out.println("최대값 : " + Integer.MAX_VALUE + ", 최소값 : " + Integer.MIN_VALUE);
		
		 // 4.float 과 double 형 타입을 하나씩 초기화 해보세요.
		System.out.println("최대값 : " + Float.MAX_VALUE + ", 최소값 : " + Float.MIN_VALUE);
		float a = 3.1232F;
		double s = 3.5D;
		 ...
		 //5.아래 코드에서 에러가 발생하는 부분과 그 이유를 기술하고 수정 해보세요
		   //byte by = 20; short sh = by; //중복
		   long lo = 20L; float fl = lo;    //틀린거 없음
		   //float f= 20; long lo2 = f;        //float이 long보다 큰데 거꾸로 말함
